...
import { FilePreview, ImagePreview, ZipPreview } from './file-preview';
import { FileRequirements } from './file-requirements';
import { parseTRPCClientErrorMessage } from '@worksheets/util/trpc';
import { compact } from 'lodash';
import { loadImage, uploadFileWithProgress } from './util';
...
export const FileUploader = ({
  ...
  const [preview, setPreview] = useState<FilePreview>(EMPTY_FILE_PREVIEW);
