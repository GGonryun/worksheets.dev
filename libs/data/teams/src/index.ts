...
export const teams: SeedableTeam[] = [
  {
    ...
    id: 'charity-games',
    name: 'Charity Games',
    logo: 'https://storage.googleapis.com/charity-games/_developers/charity-games.png',
    description:
  ...
  },
  {
    ...
    id: 'wmgcat',
    name: 'wmgcat',
    logo: 'https://storage.googleapis.com/charity-games/_developers/wmgcat.png',
    description:
  ...
  },
  {
    ...
    id: 'syb-coin-coin',
    name: 'Syb Coin Coin',
    logo: 'https://storage.googleapis.com/charity-games/_developers/syb-coin-coin.png',
    description:
  ...
  },
  {
    ...
    id: 'gordo-raba',
    name: 'GordoRaba',
    logo: 'https://storage.googleapis.com/charity-games/_developers/gordo-raba.png',
    description:
      'Charity Games is developing games that raise money for charity. We believe everyone should have access to clean water!',
    ...defaults,
    links: {
  ...
  },
  {
    ...
    logo: 'https://storage.googleapis.com/charity-games/_developers/llstd.png',
    description:
  ...
  },
  {
    ...
    id: 'rainboworm',
    name: 'Rainboworm',
    logo: 'https://storage.googleapis.com/charity-games/_developers/rainboworm.png',
    description:
  ...
  },
  {
    ...
    id: 'seredim',
    name: 'SereDim',
    logo: 'https://storage.googleapis.com/charity-games/_developers/seredim.jpeg',
    description:
      'Charity Games is developing games that raise money for charity. We believe everyone should have access to clean water!',
    ...defaults,
    links: {
  ...
  },
  {
    ...
    id: 'whitgroves',
    name: 'Whitgroves',
    logo: 'https://storage.googleapis.com/charity-games/_developers/whitgroves.jpeg',
    description:
  ...
  },
  {
    ...
    id: 'ale-tobias',
    name: 'Ale Tobias',
    logo: 'https://storage.googleapis.com/charity-games/_developers/ale-tobias.png',
    description:
